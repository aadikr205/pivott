...
const CURRICULUM_CATALOG = {
  ...
  3: {
    'Biology': [
      ...
      'Living in Harmoney with Nature'
    ],
    'Science': [
  ...
  4: {
    'Biology': [
      'Photosynthesis: How Green Leaves Make Food',
 ...
 * Falls back to sensible related subject or curriculum defaults.
 */
function getCurriculumChapters(classLevel, subject) {
 ...
 */
function getAvailableSubjectsForClass(classLevel) {
  const numericClass = parseInt(classLevel, 10) || 8;
  const gradeData = CURRICULUM_CATALOG[numericClass] || CURRICULUM_CATALOG[8];
